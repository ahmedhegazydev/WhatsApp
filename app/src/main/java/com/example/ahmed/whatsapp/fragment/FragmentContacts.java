...
public class FragmentContacts extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewRoot = inflater.inflate(R.layout.frag_contacts, container, false);
