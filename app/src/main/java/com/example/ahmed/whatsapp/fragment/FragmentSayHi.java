...
import com.example.ahmed.whatsapp.activity.MainActivity;
...
public class FragmentSayHi extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        viewRoot = inflater.inflate(R.layout.frag_say_hi, container, false);
...
//       }
        ...
        viewPager.setAdapter(new ViewPagerAdapter(getChildFragmentManager(), listFragments, indicators));
